...
public class LoggerTests {
	 ...
	 */
	/*
	 * @Autowired private InterfaceLog interfaceLog;
	 * 
	 * @Autowired private DebugLog debugLog;
	 * 
	 * @Autowired private RuntimeLog runtimeLog;
	 * 
	 * @Autowired private SecurityLog securityLog;
	 * 
	 * @Test public void testInterfaceLog() {
	 * 
	 * 
	 * InterfaceLogParamsMandatory mandatoryParam = new
	 * InterfaceLogParamsMandatory("test", "interfaceType", "interfaceName",
	 ...
	 * 
	 * 
	 * @Test public void testRuntimeLog() {
	 * 
	 * runtimeLog.info( "operation", "traceuniqueid", "message"); }
	 * 
	 * @Test public void testSecurityLog() { securityLog.error("userName",
	 * "resultInfo", "staticInfo", "externalInfo"); }
	 */
}
